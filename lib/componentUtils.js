...
(() => {
   ...
   * @return {Object} - Promise object which returns void
   */
   ...
   * create a directory
   * @param {string} path - directory path
   * @return {Object} - Promise object which returns path string
   */
   ...
   * @return {Object} - Promise object which returns createDir()
   */
   ...
   * @return {Object} - Promise object which returns callback
   */
   ...
   * @param {string} path - file path
   * @return {Object} - Promise object which returns boolean
   */
