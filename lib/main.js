...
"use strict";
{
  ...
  class StorageTmp {
     ...
     * @param {{dir:string, id:string, host:string, target:string}} des
    ...
    /**
     * set descendant property key / value
    ...
    set(des = {}, val = null) {
      ...
      const id = isString(des.id) && des.id;
