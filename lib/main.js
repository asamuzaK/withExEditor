		...
		*/
		const setItems = bool => {
			...
			bool && prefsFile && (
				...
				editorName = stored && stored.editorPath && stored.editorPath === stored.prefsFile && stored.editorName ? stored.editorName : getFileNameFromUriPath(urls.URL(urls.fromFilename(prefsFile)).path, "ExEditor")
			);
