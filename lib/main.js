...
"use strict";
{
  ...
  class ChildProcess {
     ...
     * @param {Function} [arg.onTerminate] - callback on child process terminate
     * @param {boolean} [arg.shell] - run command within a shell
     */
    constructor(arg) {
      ...
      this.cb = arg && typeof arg.onTerminate === "function" &&
                  arg.onTerminate || null;
