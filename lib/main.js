...
(() => {
	...
	const PREFS_INITIALIZE_ON_DISABLE = "WithExEditorPrefsInitializeOnDisable";
	...
	exports.main = (option, callback) => {
		let storageTmpFilesProcessId, tmpDir, processIdTmpDir,
			prefsFile, prefsCmdArgs, prefsEnvDisplay, prefsAccessKey, prefsEnablePb, prefsForceRemove,
			isPb, isEnabled,
		...
		function logOnError(e) {
			console.error(e.operation ? e.operation : e.message ? e.message : e);
		}
	...
	exports.onUnload = (reason) => {
		...
		reason === "disable" && simplePrefs.prefs[PREFS_INITIALIZE_ON_DISABLE] === true && (
			...
			simplePrefs.prefs[PREFS_FILE_NAME] && (simplePrefs.prefs[PREFS_FILE_NAME] = ""),
			simplePrefs.prefs[PREFS_CMD_ARGS] && (simplePrefs.prefs[PREFS_CMD_ARGS] = ""),
			simplePrefs.prefs[PREFS_ENV_DISPLAY] && (simplePrefs.prefs[PREFS_ENV_DISPLAY] = ""),
			simplePrefs.prefs[PREFS_ACCESS_KEY] && (simplePrefs.prefs[PREFS_ACCESS_KEY] = "e"),
			simplePrefs.prefs[PREFS_ENABLE_PB] && (simplePrefs.prefs[PREFS_ENABLE_PB] = false),
			simplePrefs.prefs[PREFS_FORCE_REMOVE] && (simplePrefs.prefs[PREFS_FORCE_REMOVE] = false),
			simplePrefs.prefs[PREFS_INITIALIZE_ON_DISABLE] && (simplePrefs.prefs[PREFS_INITIALIZE_ON_DISABLE] = false)
		);
	};
})();
