...
"use strict";
{
  ...
  class TemporaryStorage {
     ...
     * @param {{dir:string, tId:string, host:string, target:string}}
     *        keys - descendant property keys
     * @return {*}
     */
    get(keys) {
  ...
  class ChildProcess {
    /**
     * @param {{app:string, cmd:string, opt:Object, onTerminate:Function}}
     *        arg - arguments
     */
    constructor(arg) {
  ...
  class AccessKey {
    /**
     * @param {{key:string, hotkey:boolean, onPress:Function, pageMod:boolean}}
     *        opt - key settings
     */
    constructor(key = {}) {
      this._key = isString(opt.key) && otp.key.length === 1 && otp.key || "";
