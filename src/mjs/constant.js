...
export const FILE_EXT_SELECT_MD = 'selectMarkdownFileExtension';
export const FILE_EXT_SELECT_TXT = 'selectTxtFileExtension';
...
export const MODE_EDIT_EXT = 'modeEditTextFileExtention';
